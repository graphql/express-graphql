...
function graphqlHTTP(options) {
    ...
    return async function graphqlMiddleware(request, response) {
        ...
        try {
            ...
            if (schema == null) {
                throw http_errors_1.default(500, 'GraphQL middleware options must contain a schema.');
            }
            ...
            response.statusCode = (_o = error.status) !== null && _o !== void 0 ? _o : 500;
            const { headers } = error;
            if (headers != null) {
            ...
            result = { data: undefined, errors: (_p = error.graphqlErrors) !== null && _p !== void 0 ? _p : [error] };
        }
        ...
        const formattedResult = {
            ...result,
            errors: (_q = result.errors) === null || _q === void 0 ? void 0 : _q.map(formatErrorFn),
        };
