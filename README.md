...
- **`rootValue`**: A value to pass as the `rootValue` to the `execute()`
  function from [`GraphQL.js/src/execution/execute.ts`](https://github.com/graphql/graphql-js/blob/main/src/execution/execute.ts#L143).

- **`context`**: A value to pass as the `contextValue` to the `execute()`
  function from [`GraphQL.js/src/execution/execute.ts`](https://github.com/graphql/graphql-js/blob/main/src/execution/execute.ts#L143). If `context` is not provided, the
